...
DESCRIPTOR.extensions_by_name['motorsCommand'] = motorsCommand
DESCRIPTOR.extensions_by_name['currentSpeedRequest'] = currentSpeedRequest
DESCRIPTOR.extensions_by_name['currentSpeed'] = currentSpeed

MotorsSpeed = _reflection.GeneratedProtocolMessageType('MotorsSpeed', (_message.Message,), dict(
  DESCRIPTOR = _MOTORSSPEED,
  __module__ = 'roboclaw_pb2'
