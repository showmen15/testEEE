...
class RoboclawController(MessageHandler):
    def __init__(self, pipe_in, pipe_out, port):
        ...
        self.__roboclaw_front = Roboclaw(port, FRONT_RC_ADDRESS)
        self.__roboclaw_rear = Roboclaw(port, REAR_RC_ADDRESS)
    ...
    def __handle_current_speed_request(self, received_header, received_message, response_header, response_message):
        ...
        response_message.Extensions[roboclaw_pb2.currentSpeed].frontLeftSpeed = int(front_left[0])
        response_message.Extensions[roboclaw_pb2.currentSpeed].frontRightSpeed = int(front_right[0])
        response_message.Extensions[roboclaw_pb2.currentSpeed].rearLeftSpeed = int(rear_left[0])
        response_message.Extensions[roboclaw_pb2.currentSpeed].rearRightSpeed = int(rear_right[0])
